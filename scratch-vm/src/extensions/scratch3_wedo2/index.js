...
class WeDo2Motor {
    ...
    constructor (parent, index) {
        ...
        console.log("WeDo2Motor Constructor:")
...
class WeDo2 {
    ...
    constructor (runtime, extensionId) {
        ...
        console.log("WeDO bluetooth Constructor")
    ...
    displayMatrix (matrix) {
        ...
        const cmd = this.generateOutputCommand(
            ...
            WeDo2ConnectID.LED_MATRIX,

            WeDo2Command.LED_MATRIX,
    ...
    generateOutputCommand (connectID, commandID, values = null) {
        ...
        console.log("generateOutputCommand:")
    ...
    generateInputCommand (connectID, type, mode, delta, units, enableNotifications) {
        ...
        console.log("generateInputCommand:")
    ...
    _onConnect () {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            this._sensors.ledMatrixState[i] = 0;
        ...
        console.log("Battery Check: Suku")

        console.log("Register motor");

        this._registerSensorOrMotor(1,WeDo2Device.MOTOR);

        this._registerSensorOrMotor(2,WeDo2Device.MOTOR);

        this._registerSensorOrMotor(6,WeDo2Device.DISTANCE);

        // this.displayMatrix(this._sensors.ledMatrixState);
    ...
    _checkBatteryLevel () {
        ...
        console.log("_checkBatteryLevel:")
    ...
    _registerSensorOrMotor (connectID, type) {
        ...
        console.log("_registerSensorOrMotor:")
     ...
     */
        ...
        displaySymbol (args) {
            ...
            if (hex !== null) {
                ...
                this._peripheral.displayMatrix(ledMatrixState);

            }

            console.log("Super appu");
